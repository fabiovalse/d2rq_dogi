...
(function() {
  var color, height, margin, prefixes, query, svg, url, width, x, x_axis, y, y_axis;

  if (resource.uri.split('/').slice(-2)[0] === 'Agent') {
    ...
    d3.json(url, function(error, data) {
      var a_rate, bars, enter_bars, not_a_rate;
      ...
      data = [
        {
          value: a_rate,
          id: 'A',
          desc: 'articles published on journals rated with class A.'
        }, {
          value: not_a_rate,
          id: 'Not A',
          desc: 'articles published on journals rated with a class different from A.'
        }
      ];
