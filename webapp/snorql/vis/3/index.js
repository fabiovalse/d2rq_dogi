...
(function() {
  var arc, arcTween, color, color_opacity, duration, get_color, height, lod, partition, radius, redraw, svg, width, zoom, zoomable_layer;
  ...
  redraw(d3.select('input[checked]').node().value === 'count');
